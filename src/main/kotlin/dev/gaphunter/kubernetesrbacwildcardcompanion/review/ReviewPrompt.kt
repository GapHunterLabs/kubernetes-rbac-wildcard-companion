package dev.gaphunter.kubernetesrbacwildcardcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.kubernetesrbacwildcardcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.kubernetesrbacwildcardcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Kubernetes RBAC Wildcard Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/34000-kubernetes-rbac-wildcard-companion/reviews"
